...
loads cleanly even when vector-lens[projection] is not installed.
"""
...
from vlens.projection.jobs import ProjectionJobStore, ProjectionParams, ProjectionPoint
...
def _run_umap(
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install vector-lens[projection]"
        ) from exc
