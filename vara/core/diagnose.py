...
from vara.adapters.base import QueryHit, VecDBAdapter, VectorRecord
from vara.core.debug import debug_query
from vara.core.rules import (
...
async def diagnose_retrieval(
    ...
    *,
    ...
    Args:
        ...
        filters: Optional Vara-canonical filter dictionary.
